...
<div class="form-box">
  <h1 class="form-box__title">Welcome to online TDL</h1>
    ...
    <form class="form-box__form form" action="register.php" method="post">
      <input class="form__text-input" type="text" name="login" id="e-mail" placeholder="username" required>
      <input class="form__text-input" type="email" name="e-mail" id="e-mail" placeholder="e-mail" required>
      <input class="form__text-input" type="password" name="haslo" id="password" placeholder="password" required>
	  <?php
